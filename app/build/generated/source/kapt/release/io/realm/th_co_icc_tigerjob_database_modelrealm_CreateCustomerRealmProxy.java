...
public class th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxy extends th.co.icc.tigerjob.database.modelrealm.CreateCustomer
    implements RealmObjectProxy, th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface {

    static final class CreateCustomerColumnInfo extends ColumnInfo {
        ...
        CreateCustomerColumnInfo(OsSchemaInfo schemaInfo) {
            super(10);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("CreateCustomer");
        ...
        CreateCustomerColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }
        ...
        protected final ColumnInfo copy(boolean mutable) {
            return new CreateCustomerColumnInfo(this, mutable);
        }

        @Override
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            final CreateCustomerColumnInfo src = (CreateCustomerColumnInfo) rawSrc;
            final CreateCustomerColumnInfo dst = (CreateCustomerColumnInfo) rawDst;
    ...
    private CreateCustomerColumnInfo columnInfo;
    private ProxyState<th.co.icc.tigerjob.database.modelrealm.CreateCustomer> proxyState;

    th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.columnInfo = (CreateCustomerColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<th.co.icc.tigerjob.database.modelrealm.CreateCustomer>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("CreateCustomer", 10, 0);
    ...
    public static CreateCustomerColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new CreateCustomerColumnInfo(schemaInfo);
    }
    ...
    public static final class ClassNameHelper {
        public static final String INTERNAL_CLASS_NAME = "CreateCustomer";
    }

    @SuppressWarnings("cast")
    public static th.co.icc.tigerjob.database.modelrealm.CreateCustomer createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        th.co.icc.tigerjob.database.modelrealm.CreateCustomer obj = null;
        if (update) {
            Table table = realm.getTable(th.co.icc.tigerjob.database.modelrealm.CreateCustomer.class);
            CreateCustomerColumnInfo columnInfo = (CreateCustomerColumnInfo) realm.getSchema().getColumnInfo(th.co.icc.tigerjob.database.modelrealm.CreateCustomer.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(th.co.icc.tigerjob.database.modelrealm.CreateCustomer.class), false, Collections.<String> emptyList());
                    obj = new io.realm.th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("customerCode")) {
                if (json.isNull("customerCode")) {
                    obj = (io.realm.th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxy) realm.createObjectInternal(th.co.icc.tigerjob.database.modelrealm.CreateCustomer.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxy) realm.createObjectInternal(th.co.icc.tigerjob.database.modelrealm.CreateCustomer.class, json.getString("customerCode"), true, excludeFields);
                }
            } else {
        ...
        final th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface objProxy = (th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) obj;
    ...
    public static th.co.icc.tigerjob.database.modelrealm.CreateCustomer createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final th.co.icc.tigerjob.database.modelrealm.CreateCustomer obj = new th.co.icc.tigerjob.database.modelrealm.CreateCustomer();
        final th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface objProxy = (th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static th.co.icc.tigerjob.database.modelrealm.CreateCustomer copyOrUpdate(Realm realm, th.co.icc.tigerjob.database.modelrealm.CreateCustomer object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (th.co.icc.tigerjob.database.modelrealm.CreateCustomer) cachedRealmObject;
        }

        th.co.icc.tigerjob.database.modelrealm.CreateCustomer realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(th.co.icc.tigerjob.database.modelrealm.CreateCustomer.class);
            CreateCustomerColumnInfo columnInfo = (CreateCustomerColumnInfo) realm.getSchema().getColumnInfo(th.co.icc.tigerjob.database.modelrealm.CreateCustomer.class);
            long pkColumnIndex = columnInfo.customerCodeIndex;
            String value = ((th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) object).realmGet$customerCode();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(th.co.icc.tigerjob.database.modelrealm.CreateCustomer.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxy();
    ...
    public static th.co.icc.tigerjob.database.modelrealm.CreateCustomer copy(Realm realm, th.co.icc.tigerjob.database.modelrealm.CreateCustomer newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        th.co.icc.tigerjob.database.modelrealm.CreateCustomer realmObject = realm.createObjectInternal(th.co.icc.tigerjob.database.modelrealm.CreateCustomer.class, ((th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) newObject).realmGet$customerCode(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface realmObjectSource = (th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) newObject;
        th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface realmObjectCopy = (th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, th.co.icc.tigerjob.database.modelrealm.CreateCustomer object, Map<RealmModel,Long> cache) {
        ...
        CreateCustomerColumnInfo columnInfo = (CreateCustomerColumnInfo) realm.getSchema().getColumnInfo(th.co.icc.tigerjob.database.modelrealm.CreateCustomer.class);
        long pkColumnIndex = columnInfo.customerCodeIndex;
        String primaryKeyValue = ((th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) object).realmGet$customerCode();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$customerName = ((th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) object).realmGet$customerName();
        ...
        String realmGet$address = ((th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) object).realmGet$address();
        if (realmGet$address != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.addressIndex, rowIndex, realmGet$address, false);
        }
        String realmGet$subdistrict = ((th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) object).realmGet$subdistrict();
        ...
        String realmGet$district = ((th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) object).realmGet$district();
        if (realmGet$district != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.districtIndex, rowIndex, realmGet$district, false);
        }
        String realmGet$province = ((th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) object).realmGet$province();
        if (realmGet$province != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.provinceIndex, rowIndex, realmGet$province, false);
        }
        String realmGet$zipcode = ((th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) object).realmGet$zipcode();
        if (realmGet$zipcode != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.zipcodeIndex, rowIndex, realmGet$zipcode, false);
        }
        String realmGet$tel = ((th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) object).realmGet$tel();
        if (realmGet$tel != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.telIndex, rowIndex, realmGet$tel, false);
        }
        String realmGet$lat = ((th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) object).realmGet$lat();
        if (realmGet$lat != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.latIndex, rowIndex, realmGet$lat, false);
        }
        String realmGet$lng = ((th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) object).realmGet$lng();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        CreateCustomerColumnInfo columnInfo = (CreateCustomerColumnInfo) realm.getSchema().getColumnInfo(th.co.icc.tigerjob.database.modelrealm.CreateCustomer.class);
        long pkColumnIndex = columnInfo.customerCodeIndex;
        th.co.icc.tigerjob.database.modelrealm.CreateCustomer object = null;
        while (objects.hasNext()) {
            object = (th.co.icc.tigerjob.database.modelrealm.CreateCustomer) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, th.co.icc.tigerjob.database.modelrealm.CreateCustomer object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(th.co.icc.tigerjob.database.modelrealm.CreateCustomer.class);
    ...
    public static th.co.icc.tigerjob.database.modelrealm.CreateCustomer createDetachedCopy(th.co.icc.tigerjob.database.modelrealm.CreateCustomer realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        th.co.icc.tigerjob.database.modelrealm.CreateCustomer unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new th.co.icc.tigerjob.database.modelrealm.CreateCustomer();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (th.co.icc.tigerjob.database.modelrealm.CreateCustomer) cachedObject.object;
            }
            unmanagedObject = (th.co.icc.tigerjob.database.modelrealm.CreateCustomer) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface unmanagedCopy = (th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) unmanagedObject;
        th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface realmSource = (th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) realmObject;
    ...
    static th.co.icc.tigerjob.database.modelrealm.CreateCustomer update(Realm realm, th.co.icc.tigerjob.database.modelrealm.CreateCustomer realmObject, th.co.icc.tigerjob.database.modelrealm.CreateCustomer newObject, Map<RealmModel, RealmObjectProxy> cache) {
        th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface realmObjectTarget = (th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) realmObject;
        th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface realmObjectSource = (th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxyInterface) newObject;
    ...
    public boolean equals(Object o) {
        ...
        th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxy aCreateCustomer = (th_co_icc_tigerjob_database_modelrealm_CreateCustomerRealmProxy)o;

        String path = proxyState.getRealm$realm().getPath();
        String otherPath = aCreateCustomer.proxyState.getRealm$realm().getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;

        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = aCreateCustomer.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getIndex() != aCreateCustomer.proxyState.getRow$realm().getIndex()) return false;
