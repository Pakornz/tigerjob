...
class JobListActivity : BaseActivity() {
    ...
    private var listData: List<Job>? = null
    lateinit var listAdapter: JobListAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listAdapter.onVideoClick = object : JobListAdapter.OnVideoClick  //set button
        {
...
//            }
        ...
        listAdapter.typeList = realmDatabase!!.ListJob(showdate)
...
//            }
    ...
    private fun createDatePickerDialog(minDate: Date?, maxDate: Date?): DatePickerDialog {
        ...
        val datePickerDialog = DatePickerDialog(this@JobListActivity,
...
//            realmDatabase.deleteListJob(showdate)
//            realmDatabase.close()
//
//            val handler = Handler()
//            handler.postDelayed({
...
//
//            callApi = Service()
//            callApi.deleteApiDeleteJob(cus,object : Service.UploadCallBack{
...
//    }
    ...
    private fun createUserDetailDialog(cus:String): AlertDialog
    {
        ...
        userHandHeldIdTextView.text = "รหัสงาน : $cus"
    ...
    class JobListAdapter : RecyclerView.Adapter<JobListAdapter.TypeViewHolder>()
    {
        var typeList : ArrayList<Job> = ArrayList()
...
//            fun onClickUser(cus:String)
        ...
        override fun onBindViewHolder(holder: TypeViewHolder, position: Int) {
            ...
            holder.textname0.text = "เวลา : "+type.currenttime
            holder.textname1.text = type.jobNo
            holder.textname2.text = type.customerCode
            holder.textname3.text = "จำนวนกล่อง : "+type.box
            holder.textname4.text = "ชื่อ : "+type.contact

            holder.cardview.setOnClickListener {
                onVideoClick?.onClickItem(type.jobNo)
            }

//            holder.deletee.setOnClickListener {
//                onVideoClick?.onClickUser(type.jobNo)
//            }
        ...
        {
            val textname0 : TextView = view.findViewById(R.id.country_name0)
            ...
            val textname4 : TextView = view.findViewById(R.id.country_name4)
